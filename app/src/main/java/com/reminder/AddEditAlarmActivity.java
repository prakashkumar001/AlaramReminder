...
import com.reminder.service.AlarmReceiver;
import com.reminder.service.LoadAlarmsService;
import com.reminder.util.ViewUtils;
...
public final class AddEditAlarmActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mLabel = (EditText)findViewById(R.id.edit_alarm_label);
        ...
        save= (TextView) findViewById(R.id.action_save);
        delete= (TextView)findViewById(R.id.action_delete);
